<cfscript>
// Quick test to verify REPLTool security fixes are working
...
try {
    ...
    writeOutput("<li>Should show 'ctx_data value: This is allowed data'</li>");
    writeOutput("</ul>");
    ...
    writeOutput("<li>Should show 'malicious value: not found' (variable not accessible)</li>");
    writeOutput("</ul>");
    ...
    writeOutput("<li>Should execute successfully</li>");
    writeOutput("</ul>");
